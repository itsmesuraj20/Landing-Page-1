...
const Header = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-opacity-90 lg:backdrop-blur-sm ${openNavigation ? "bg-n-8" : "bg-n-8/90 backdrop-blur-sm"}`}>
    <h1>Hello World</h1>
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav className={`${openNavigation ? 'flex' : 'hidden'} fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent`}>
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            ...
            <HamburgerMenu onClick={() => setOpenNavigation(!openNavigation)} />
        </nav>

        <a href="#signup" className="button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block">
          New Account
        </a>
        <Button className="hidden lg:flex" href="">Sign In</Button>
